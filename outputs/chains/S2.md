...
- 기대 분기: `suppress`, 기대 1순위: `permitted_maintenance`
...
- 디스카운트 합 -15.0 (허가 -15, METOC -0.0, 센서 -0.0)
...
```json
{
  ...
  "risk": 48.75,
  "top_candidate": "permitted_maintenance",
  "branch": "suppress"
}
```

## 7. 판단 분기
- **`suppress`** — 양성 후보 'permitted_maintenance'(점수 0.95) 1순위, risk 48.8 → 오탐 억제.
- 기대 `suppress` 대비 **✓ 일치**
